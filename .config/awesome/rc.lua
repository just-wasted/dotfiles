...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "e", revelation, { description = "preview all clients", group = "client" }),
	...
	end, { description = "rofi show windows", group = "launcher" }),
	...
	awful.key({ modkey, "Control" }, "c", function()
		awful.spawn.with_shell("~/scripts/conkytoggle.sh")
	end, { description = "toggle conky", group = "launcher" })
)
...
clientkeys = gears.table.join(
	...
	end, { description = "decrease client size", group = "client" }),
	awful.key({ modkey }, ",", function()
		awful.client.incwfact(0.05)
