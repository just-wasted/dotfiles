...
--      gears.shape.rounded_rect(cr, width, height, 6)
        gears.shape.partially_rounded_rect(cr, width, height, false, false, true, true, 9)
    end 
...
--  local sgeo = s.geometry()
    ...
    s.mywibox.x = 16
    s.mywibox.opacity = 1
    s.mywibox.stretch = false
    s.mywibox.width = 1884.0
    s.mywibox.height = 18.0
    s.mywibox.shape = custom_shape_wibar
    s.mywibox.bg =  gears.color({ type = "linear",
                                    from = { 0, 18 },
                                    to = { 1080, 18 },
                                    stops = { { 0, "#282828" }, { 1, "#6a6a6a" } }
                                 })
    s.mywibox.border_width = 3
    s.mywibox.border_color = beautiful.border_focus
